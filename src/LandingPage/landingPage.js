              ...
              <Row>
                <Col lg="6" md="6" sm="12" className="Cols2textDiv">
                  <div className="s2textDiv">
                    ...
                    <H1>
                      {" "}
                      Unlock The Power of Nature with Airoco Organic Air
                      Purifier
                    </H1>
                    <P1>
                      Creating a healthier & delightful environment with a new
                      type of purifier, inspired by nature.
                    </P1>
                    <PreBookButton />
                  </div>
                </Col>
              ...
              <Row>
                ...
                <Col lg="6" md="6" sm="12" className="Cols2textDiv">
                  <div className="s2textDiv">
                    ...
                    <P1>
                      Airoco is an innovative natural product design that
                      equally effectively cleans the air you breathe without
                      affecting the environment. Inspired by the English
                      countryside, Airoco uses aesthetic materials to connect
                      you with nature. The wish list hides a host of features
                      and strives to keep your air clean.
                    </P1>
                    <PreBookButton />
                  </div>
                </Col>
              ...
              <Row>
                <Col lg="6" md="6" sm="12" className="Cols2textDiv">
                  <div className="s2textDiv">
                    ...
                    <P1>
                      While it was just a layman thing to just talk about nature
                      conservation on the so-called tv series! We at AIROCO went
                      a step ahead to nurture the air & our environment! It is
                      one of those feelings that drive our love of ‘Nurturing
                      Air’ & our desire to learn more & more about it!
                    </P1>
                    <PreBookButton />
                  </div>
                </Col>
