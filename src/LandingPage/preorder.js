...
<div class="main">
    <Link to="/">
    <button class="btn btn-default btn-back" type="button">Back</button></Link>
            ...
            <div class="signup-content">
                ...
                <div class="signup-form">
                    <form method="POST" class="register-form" id="register-form">
                        <h2 className="preorderHeading">Complete your pre-order<br></br>
                        <span>Pre-book your product now at    99/- only and avail a discount of flat 25% on MRP</span>
                        </h2>
...
Pre-book at     ₹99 only
                             ...
                             <img className="itemimg" src={itemimg1}></img>      </label>
...
Pre-book at     ₹99 only
                     ...
                     <p>4. Continue to payment</p>
                          ...
                          <div className="payment-div" >
                              <h4>Pre-book Charges ₹ 99</h4>
                              <p>Continue to payment</p>
<div className="btn-div">
                              <button class="btn btn-default btn-submit" type="submit">PRE-BOOK AIROCO</button>
                              </div>
                          </div>
